...
- Never start with "I'm excited to share" or "I've been thinking about"
...
- If telling a story: situation, then tension, then resolution, then insight. Skip the setup nobody needs.
...
- Mix ideas with personal moments
...
- Write like a senior executive who also builds things. Polished but battle-tested.
...
- Lead with the data but make it visceral: "73% of startups fail in year 2. I almost became one of them."
- Cite specific numbers, percentages, timeframes, and research
...
- NEVER use em dashes, en dashes, or regular dashes to connect thoughts. No "this is great — but here's the catch" or "the answer - surprisingly - was simple." Instead, use periods, commas, or line breaks to separate ideas. Write the way normal people text and post on social media.
- NEVER use arrows like this: →. Use "then" or "leads to" or just a new sentence instead.
- For emphasis, use CAPITALIZATION (sparingly, max 2-3 words per post), line breaks, and emoji instead.
- Write like a real human posting on their phone. Short sentences. Natural punctuation. No fancy typography tricks.
...
export const CONTENT_LENGTH_INSTRUCTIONS: Record<ContentLength, string> = {
  ...
  standard: `LENGTH OVERRIDE: Write this as a standard LinkedIn post. 800-1500 characters. Include hook, body with 2-3 key points, and clear CTA. This is the default LinkedIn length.`,
  longform: `LENGTH OVERRIDE: Write this as a long-form LinkedIn thought leadership post. 1500-3000 characters. In-depth analysis, multiple angles, personal story element, strong CTA. Ignore any shorter character-count guidance given elsewhere in this prompt in favor of this 1500-3000 character range.`,
};
...
export const CONTENT_LENGTH_LABELS: Record<ContentLength, { label: string; emoji: string; range: string; description: string }> = {
  ...
  short: { label: 'Short', emoji: '📝', range: '300-800 chars', description: 'Punchy and scannable. Perfect for one quick idea.' },
