  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-6">
      ...
      <nav className="fixed top-0 left-0 right-0 flex justify-between items-center px-8 py-5 z-10">
        ...
        <a href="/signup" className="text-sm px-5 py-2 rounded-full border border-white/20 hover:border-purple-500 transition-all">
          Get Early Access
        </a>
      </nav>
      ...
      <div className="text-center max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="/signup" className="px-8 py-4 rounded-full font-semibold text-white transition-all text-center"
